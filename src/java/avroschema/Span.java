...
public class Span extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Span\",\"namespace\":\"avroschema\",\"fields\":[{\"name\":\"start_index\",\"type\":\"int\"},{\"name\":\"end_index\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  @Deprecated public int start_index;
  @Deprecated public int end_index;
  ...
  public static avroschema.Span.Builder newBuilder() {
    return new avroschema.Span.Builder();
  }
  
  /** Creates a new Span RecordBuilder by copying an existing Builder */
  public static avroschema.Span.Builder newBuilder(avroschema.Span.Builder other) {
    return new avroschema.Span.Builder(other);
  }
  
  /** Creates a new Span RecordBuilder by copying an existing Span instance */
  public static avroschema.Span.Builder newBuilder(avroschema.Span other) {
    return new avroschema.Span.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Span>
    ...
    private Builder() {
      super(avroschema.Span.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avroschema.Span.Builder other) {
      super(other);
    ...
    private Builder(avroschema.Span other) {
            super(avroschema.Span.SCHEMA$);
      if (isValidValue(fields()[0], other.start_index)) {
        this.start_index = data().deepCopy(fields()[0].schema(), other.start_index);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'start_index' field */
    public avroschema.Span.Builder setStartIndex(int value) {
    ...
    public avroschema.Span.Builder clearStartIndex() {
    ...
    /** Sets the value of the 'end_index' field */
    public avroschema.Span.Builder setEndIndex(int value) {
    ...
    public avroschema.Span.Builder clearEndIndex() {
