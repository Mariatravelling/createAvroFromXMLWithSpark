        ...
        for (CoreMap sentence : sentences) {
            ...
            for (CoreMap fakeSentence : fakeSentences) {
               ...
               //adding new ones 
                ...
                GrammaticalStructure gs = parser.predict(fakeSentence);
                SemanticGraph uncollapsedDeps = SemanticGraphFactory.generateUncollapsedDependencies(gs);
                
                //SemanticGraph dependencies= sentence.get(BasicDependenciesAnnotation.class);
                List<SemanticGraphEdge> it = uncollapsedDeps.edgeListSorted();
                String res="";
        	      for(int h=0;h<it.size();h++)
        	      {
        	    	  res=res+it.get(h).toString()+";";
        	      }
      	    ...
      	    //tuple.append(out);
                ...
                if (temp > 0) {
                    ...
                    String str1=egs.allTypedDependencies().toString();
                    
                    String str2 = GrammaticalStructure.dependenciesToString(egs, egs.typedDependencies(), tree, true, true);
                    tuple.append(str1);
                    tuple.append(str2);
